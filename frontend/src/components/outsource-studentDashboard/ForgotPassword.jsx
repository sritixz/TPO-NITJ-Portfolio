...
const ForgotPassword = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      await toast.promise(
        axios.post(`${import.meta.env.REACT_APP_BASE_URL}/outsource-internships-auth/send-resetpassword-otp`, { email }),
        {
          loading: "Sending OTP...",
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      await toast.promise(
        axios.post(`${import.meta.env.REACT_APP_BASE_URL}/outsource-internships-auth/verify-resetpassword-otp`, { email, otp }, { withCredentials: true }),
        {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      await toast.promise(
        axios.post(`${import.meta.env.REACT_APP_BASE_URL}/outsource-internships-auth/reset-password`, {
          email,
          newPassword,

...
const OutsourceInternshipPage = () => {
  ...
  <div className="flex-1">
    <p className="text-gray-700 leading-relaxed">
      Please refer the{' '}
      <a
        href="/Summer - Winter Outsource Intership.xlsx" // Replace with your actual file path in public folder, e.g., /path/to/faculty-list.pdf
        target="_blank"
        rel="noopener noreferrer"
        className="text-custom-blue hover:underline font-medium"
        download // Optional: Adds download attribute for direct download
      >
        attached list
      </a>{' '}
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-custom-blue hover:text-blue-800 font-medium transition-colors"
              >
                <CreditCard size={16} />
  ...
  const moreThan3MonthsContent = (
    <div className="mt-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-custom-blue shadow-sm overflow-hidden">
      ...
      <div className="p-6">
        ...
        <button className="mt-6 w-full bg-custom-blue to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2">
          <FileText size={20} />

...
//         // physicallyDisabled: userData.disability || '',
//         category: userData.category || '',
//         // interested: userData.isInterested || ''
//       }));
//     }
//   }, [userData]);
...
//       return false;
//     }
//     if (formData.notInterestedReason === "Other reason" && !formData.otherReason.trim()) {
//       toast.error('Please specify your reason for not being interested.');
//       return false;
//     }
//   }
...
//       case 3:
//   const reasons = [
//     "Want to focus on higher studies",
//     "Not interested in core jobs",
//     "Prefer entrepreneurship",
//     "Other reason"
//   ];
...
//     type="button"
//     onClick={() =>
//       setFormData(prev => ({ ...prev, physicallyDisabled: option === "Yes" }))
//     }
...
//                 onChange={handleInputChange('otherReason')}
  ...
  const validateStep = () => {
    ...
    if (currentStep === 3) {
      ...
      if (!formData.interested && !formData.description.trim()) {
        toast.error('Please select or specify a reason for not being interested.');
        return false;
      }

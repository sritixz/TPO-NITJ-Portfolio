...
export default function InterviewCard({
  ...
  const renderInterviewLink = () => {
    ...
    if (interview_link) {
      const validLink = 
        typeof interview_link === "string" && interview_link.startsWith("http")
          ? interview_link
      ...
      <div className="p-4">
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center text-gray-700 text-sm">
            ...
            <span className="text-gray-600">{interview_type || "Not Provided"}</span>
          </div>

          <div className="flex items-center text-gray-700 text-sm">
            <Clock className="mr-2 text-custom-blue" size={16} />
            <span className="font-medium mr-1">Date:</span>
            <span className="text-gray-600">{formatDate(interview_date)}</span>
          </div>

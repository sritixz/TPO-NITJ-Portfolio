...
const CreateJob = ({ onJobCreated, onCancel }) => {
  ...
  return (
    <>
      <button
        className="text-gray-500 ml-2 mr-4 rounded-2xl hover:from-gray-600 hover:to-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl"
        onClick={onCancel}
      >
        <FaArrowLeft />
      </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <input
                ...
                readOnly
                className="w-full border-2 border-gray-200 rounded-xl p-3 bg-gray-100 cursor-not-allowed focus:outline-none transition-all duration-300"
              />
            </div>
            <div>
              <label className="block text-gray-700 font-semibold mb-2">

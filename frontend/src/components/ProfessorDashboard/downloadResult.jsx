...
//     try {
//       const res = await axios.get("http://localhost:7000/api/placements");
...
// const downloadPlacementPDF = async (placement) => {
//   const blob = await pdf(<PlacementPDF placement={placement} />).toBlob();
//   const url = URL.createObjectURL(blob);

//   const link = document.createElement("a");
//   link.href = url;
//   link.download = `${placement.company_name || "placement"}_result.pdf`;
...
// const PlacementsTable = ({ placements, loading }) => {
//   if (loading) {
//     return (
...
//             <th className="px-4 py-3 text-center">Students Placed</th>
...
//               </td>
//               <td className="px-4 py-2">{placement.batch || "N/A"}</td>
//               <td className="px-4 py-2">{placement.course || "N/A"}</td>
//               <td className="px-4 py-2">{placement.offer_mode || "N/A"}</td>
//               <td className="px-4 py-2">{placement.offer_sector || "N/A"}</td>
...
//               <td className="px-4 py-2 text-center">
//                 <button
//                   onClick={() => downloadPlacementPDF(placement)}
...
//               style={[
//                 styles.tableCell,
//                 { fontWeight: "semibold", flex: 1, marginRight: 10 },
//               ]}
//             >
//               Student Name
//             </Text>
//             <Text
//               style={[styles.tableCell, { fontWeight: "semibold", flex: 1 }]}
//             >
//               Gender
//             </Text>
//             <Text
...
//                 <Text style={[styles.tableCell, { flex: 1, marginRight: 10 }]}>
//                   {student.name || "N/A"}
//                 </Text>
...
//           </div>
//         </div>
//         <Download className="w-5 h-5 text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
//       </div>
//     </div>
//   );
// };

// const downloadResult = ({ placements = [], loading = false }) => {
//   if (loading) {
//     return (
...
//         </div>
//         <PlacementsTable placements={placements} loading={loading} />
//       </div>
//     );
//   }

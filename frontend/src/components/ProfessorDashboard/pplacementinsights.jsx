    ...
    <div className="font-sans p-6 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 border-b border-gray-200 pb-4">
          <h2 className="text-3xl font-bold text-custom-blue mb-4 md:mb-0">Placement Reports</h2>
          <button
        ...
        {reportData.length > 0 && (
          <div className="flex items-center bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-3 mb-4 border-l-4 border-blue-400 shadow-sm">

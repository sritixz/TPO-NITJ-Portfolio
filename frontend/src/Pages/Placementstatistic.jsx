...
const Placementstatistics = () => {
  ...
  const calculateYAxisWidth = (data) => {
  const maxLength = Math.max(...data.map(d => d.department.length));
  return Math.min(120, Math.max(40, maxLength * 7)); // min 40, max 120
};


  const programs = ['B.Tech', 'M.Tech'];
  const bTechBatches = ['2025', '2024', '2023', '2022', '2021'];
  const mTechBatches = ['2025', '2024', '2023'];
  ...
  const batchImages = {
    ...
    'M.Tech': {
      '2025': '/stats/mtech-2023-25.png',
      '2024': '/stats/mtech-2022-24.png',
      '2023': '/stats/mtech-2021-23.png'
    }
  };

  // Data for B.Tech and M.Tech
  const data = {
    'B.Tech': {
      '2025': {
      ugPlacement: [
  ...
  { branch: 'TT', ctc: 6.51 }
    ...
    'M.Tech': {
      '2025': {
        pgPlacement: [
  { department: 'Artifical Intelligence', percentage: 52.00 },
  { department: 'Computer Science & Engineering', percentage: 69.81 },
  { department: 'Information Security', percentage: 91.67 },
  { department: 'Instrumention & Control Engineering', percentage: 60.00 },
  { department: 'Data Analytics', percentage: 42.86 },
  { department: 'Data Science & Engineering', percentage: 58.82 },
  { department: 'Design Engineering', percentage: 83.33 },
  { department: 'Electrical Vehicle Design', percentage: 40.00 },
  { department: 'GEO Tech and Environmental Engg.', percentage: 0.00 },
  { department: 'Renewable Energy', percentage: 0.00 },
  { department: 'Signal Processing and Machine Learning', percentage: 100.00 },
  { department: 'Structural and Construction Engg.', percentage: 7.69 },
  { department: 'Textile Engg. & Managment Engg', percentage: 0.00 },
  { department: 'Industrial Engg. & Data Anaytics', percentage: 0.00 },
  { department: 'VLSI Design', percentage: 78.57 }
]
,
        ctcData: [
  { branch: 'Artifical Intelligence', ctc: 11.25 },
  { branch: 'Computer Science & Engineering', ctc: 16.00 },
  { branch: 'Information Security', ctc: 13.86 },
  { branch: 'Instrumention & Control Engineering', ctc: 6.03 },
  { branch: 'Data Analytics', ctc: 13.06 },
  { branch: 'Data Science & Engineering', ctc: 16.58 },
  { branch: 'Design Engineering', ctc: 11.50 },
  { branch: 'Electrical Vehicle Design', ctc: 20.00 },
  { branch: 'GEO Tech and Environmental Engg.', ctc: 0.00 },
  { branch: 'Renewable Energy', ctc: 0.00 },
  { branch: 'Signal Processing and Machine Learning', ctc: 17.60 },
  { branch: 'Structural and Construction Engg.', ctc: 15.00 },
  { branch: 'Textile Engineering and Managment Engg', ctc: 0.00 },
  { branch: 'Industrial Engineering & Data Anaytics', ctc: 0.00 },
  { branch: 'VLSI Design', ctc: 20.00 }
        ],
        ctcDistribution: [
          // { name: 'Less than 5 LPA', value: 5.00, color: '#0369A0' },
          // { name: '5+ LPA - 10 LPA', value: 30.00, color: '#FF8C42' },
          // { name: '10+ LPA - 15 LPA', value: 35.00, color: '#008080' },
          // { name: 'More than 15 LPA', value: 30.00, color: '#FFD700' }
        ],
        summaryStats: {
          percentagePlacement: '52.54%',
          totalOffers: '129',
          maxCTC: '22 LPA',
          avgCTC: '-'
        },
      ...
      '2024': {
        pgPlacement: [
  { department: 'ECE', percentage: 66.67 },
  { department: 'VLSI', percentage: 90.48 },
  { department: 'AI', percentage: 50.00 },
  { department: 'CSE', percentage: 68.00 },
  { department: 'IS', percentage: 80.00 },
  { department: 'CHE', percentage: 0.00 },
  { department: 'ICE', percentage: 0.00 },
  { department: 'CIVIL', percentage: 15.38 },
  { department: 'ME', percentage: 80.00 },
  { department: 'Renewable', percentage: 25.00 },
  { department: 'BT', percentage: 0.00 },
  { department: 'TT', percentage: 7.69 }
],
        ctcData:[
  { branch: 'ECE', ctc: 14.66 },
  { branch: 'VLSI', ctc: 18.50 },
  { branch: 'AI', ctc: 22.60 },
  { branch: 'CSE', ctc: 16.47 },
  { branch: 'IS', ctc: 19.50 },
  { branch: 'CHE', ctc: 0.00 },
  { branch: 'ICE', ctc: 0.00 },
  { branch: 'CIVIL', ctc: 5.83 },
  { branch: 'ME', ctc: 10.00 },
  { branch: 'Renewable', ctc: 6.00 },
  { branch: 'BT', ctc: 0.00 },
  { branch: 'TT', ctc: 4.00 }
],
        ctcDistribution: [
          // { name: 'Less than 5 LPA', value: 6.50, color: '#0369A0' },
          // { name: '5+ LPA - 10 LPA', value: 35.50, color: '#FF8C42' },
          // { name: '10+ LPA - 15 LPA', value: 33.00, color: '#008080' },
          // { name: 'More than 15 LPA', value: 25.00, color: '#FFD700' }
        ],
        summaryStats: {
          percentagePlacement: '43.95%',
          totalOffers: '71',
          maxCTC: '43 LPA',
          avgCTC: '-'
        },
      ...
      '2023': {
        pgPlacement: [
  { department: 'ECE', percentage: 16.67 },
  { department: 'VLSI', percentage: 29.41 },
  { department: 'AI', percentage: 0.00 },
  { department: 'CSE', percentage: 58.70 },
  { department: 'IS', percentage: 33.33 },
  { department: 'CHE', percentage: 40.00 },
  { department: 'ICE', percentage: 0.00 },
  { department: 'CIVIL', percentage: 33.33 },
  { department: 'IPE', percentage: 0.00 },
  { department: 'ME', percentage: 32.14 },
  { department: 'Renewable', percentage: 0.00 },
  { department: 'BT', percentage: 0.00 },
  { department: 'TT', percentage: 12.50 }
]
,
        ctcData: [
  { branch: 'ECE', ctc: 14.16 },
  { branch: 'VLSI', ctc: 28.40 },
  { branch: 'AI', ctc: 7.88 },
  { branch: 'CSE', ctc: 13.75 },
  { branch: 'IS', ctc: 16.81 },
  { branch: 'CHE', ctc: 8.00 },
  { branch: 'ICE', ctc: 0.00 },
  { branch: 'CIVIL', ctc: 6.60 },
  { branch: 'IPE', ctc: 0.00 },
  { branch: 'ME', ctc: 7.70 },
  { branch: 'Renewable', ctc: 0.00 },
  { branch: 'BT', ctc: 0.00 },
  { branch: 'TT', ctc: 3.60 }
]
,
        ctcDistribution: [
          // { name: 'Less than 5 LPA', value: 8.00, color: '#0369A0' },
          // { name: '5+ LPA - 10 LPA', value: 40.00, color: '#FF8C42' },
          // { name: '10+ LPA - 15 LPA', value: 32.00, color: '#008080' },
          // { name: 'More than 15 LPA', value: 20.00, color: '#FFD700' }
        ],
        summaryStats: {
          percentagePlacement: '32.05%',
          totalOffers: '79',
          maxCTC: '21 LPA',
          avgCTC: '8.20 LPA'
        },
  ...
  // Get current program and batch data
  const batches = selectedProgram === 'B.Tech' ? bTechBatches : mTechBatches;
  const isDataAvailable = data[selectedProgram][selectedBatch] !== undefined;
  const currentData = isDataAvailable ? data[selectedProgram][selectedBatch] : {};
  const placementData = isDataAvailable ? (selectedProgram === 'B.Tech' ? currentData.ugPlacement : currentData.pgPlacement) : [];
  const ctcData = isDataAvailable ? currentData.ctcData : [];
  const ctcDistribution = isDataAvailable ? currentData.ctcDistribution : [];
  const summaryStats = isDataAvailable ? currentData.summaryStats : {
    percentagePlacement: 'N/A',
    totalOffers: 'N/A',
    maxCTC: 'N/A',
    avgCTC: 'N/A'
  };
  const companies = isDataAvailable ? currentData.companies : [];
    ...
    return (
      <div className="mt-6">
        <h3 className="text-xl font-semibold text-gray-800 mb-4">
          Companies Visited <span className='text-custom-blue text-sm'>( for {selectedProgram === 'B.Tech' ? `${parseInt(selectedBatch) - 4}-${selectedBatch.slice(2)}` : `${parseInt(selectedBatch) - 2}-${selectedBatch.slice(2)}`} Batch)</span>
        </h3>
  ...
  // Function to render batch image or placeholder
      ...
      <div className="bg-white rounded-xl px-2 py-6 mt-8" style={{ boxShadow: '0 0 10px 0 rgba(0, 0, 0, 0.2)' }}>
        <div className="flex justify-center px-4">
          <div className="w-full max-w-7xl">
            <img
              src={batchImages[selectedProgram][selectedBatch]}
              alt={`Batch ${selectedProgram === 'B.Tech' ? `${parseInt(selectedBatch) - 4}-${selectedBatch.slice(2)}` : `${parseInt(selectedBatch) - 2}-${selectedBatch.slice(2)}`} highlights`}
            ...
            >
              <div className="text-center text-custom-blue font-semibold">
                ...
                <p className="text-xl font-semibold">Batch {selectedProgram === 'B.Tech' ? `${parseInt(selectedBatch) - 4}-${selectedBatch.slice(2)}` : `${parseInt(selectedBatch) - 2}-${selectedBatch.slice(2)}`}</p>
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 p-6 mt-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Header with program and batch selection */}
          <div className="mb-8">
              ...
              {programs.map(program => (
                <button
                  ...
                  onClick={() => {
                    ...
                    setSelectedBatch(program === 'B.Tech' ? '2025' : '2025');
            ...
            <div className="flex justify-center space-x-2">
              {(selectedProgram === 'B.Tech' ? bTechBatches : mTechBatches).map(batch => (
                <button
                  key={batch}
                  onClick={() => {
                ...
                >
                  {selectedProgram === 'B.Tech' ? `${parseInt(batch) - 4}-${batch.slice(2)}` : `${parseInt(batch) - 2}-${batch.slice(2)}`} Batch
                </button>
              ))}
            </div>
          </div>
          ...
          {!isDataAvailable ? (
            <div className="bg-white rounded-xl p-6 mt-8 text-center" style={{ boxShadow: '0 0 10px 0 rgba(0, 0, 0, 0.2)' }}>
              <h3 className="text-xl font-semibold text-gray-800 mb-4">
                Data Not Available
              </h3>
              <p className="text-gray-600">
                Placement statistics for {selectedProgram} {parseInt(selectedBatch) - 2}-{selectedBatch.slice(2)} batch are not available.
              </p>
            </div>
          ) : (
            <>
  ...
  <h3 className="text-lg font-semibold text-gray-800 mb-8">
    {selectedProgram} Percentage Placement ({selectedProgram === 'B.Tech' ? parseInt(selectedBatch) - 1 : parseInt(selectedBatch) - 1}-{selectedBatch.slice(-2)})
  </h3>
  <ResponsiveContainer width="100%" height={400}>
    ...
    >
      ...
      <YAxis
        dataKey="department"
        type="category"
        width={calculateYAxisWidth(placementData)} // dynamic width
        tick={{ fontSize: 12 }}
      />
...
>
  ...
  {ctcDistribution.length > 0 ? (
    ...
    <div className="flex flex-col items-center justify-center h-72 text-center text-gray-500 border border-dashed border-gray-300 rounded-lg mt-4">
      <svg
      ...
      <p className="text-sm text-gray-400">
        CTC distribution details will appear here once available.
      </p>
    </div>
  )}
</div>
  ...
  <ResponsiveContainer width="100%" height={320}>
    ...
    >
      ...
      <XAxis
        ...
        textAnchor="end"
        interval={0}
        height={60} // Increased height to fit longer names
        fontSize={12}
      />
      <YAxis />
...
//       '2025': {
//         pgPlacement: [
//           { department: 'CSE', percentage: 92.31 },
//           { department: 'ECE', percentage: 95.00 },
//           { department: 'EE', percentage: 88.89 },
//           { department: 'ME', percentage: 91.67 },
//           { department: 'CHE', percentage: 93.33 }
//         ],
//         ctcData: [
//           { branch: 'CSE', ctc: 18.50 },
//           { branch: 'ECE', ctc: 16.75 },
//           { branch: 'EE', ctc: 14.20 },
//           { branch: 'ME', ctc: 12.80 },
//           { branch: 'CHE', ctc: 10.50 }
//         ],
//         ctcDistribution: [
//           { name: 'Less than 5 LPA', value: 5.00, color: '#0369A0' },
//           { name: '5+ LPA - 10 LPA', value: 30.00, color: '#FF8C42' },
...
//       '2024': {
//         pgPlacement: [
//           { department: 'CSE', percentage: 90.00 },
//           { department: 'ECE', percentage: 92.86 },
//           { department: 'EE', percentage: 87.50 },
//           { department: 'ME', percentage: 89.47 },
//           { department: 'CHE', percentage: 91.67 }
//         ],
//         ctcData: [
//           { branch: 'CSE', ctc: 17.80 },
//           { branch: 'ECE', ctc: 15.90 },
//           { branch: 'EE', ctc: 13.50 },
//           { branch: 'ME', ctc: 12.00 },
//           { branch: 'CHE', ctc: 9.80 }
//         ],
...
//       '2023': {
//         pgPlacement: [
//           { department: 'CSE', percentage: 88.24 },
//           { department: 'ECE', percentage: 90.00 },
//           { department: 'EE', percentage: 85.71 },
//           { department: 'ME', percentage: 87.50 },
//           { department: 'CHE', percentage: 88.89 }
//         ],
//         ctcData: [
//           { branch: 'CSE', ctc: 16.50 },
//           { branch: 'ECE', ctc: 14.75 },
//           { branch: 'EE', ctc: 12.80 },
//           { branch: 'ME', ctc: 11.50 },
//           { branch: 'CHE', ctc: 9.00 }
//         ],
...
//   // Get current program and batch data
//   const currentData = data[selectedProgram][selectedBatch];
//   const placementData = selectedProgram === 'B.Tech' ? currentData.ugPlacement : currentData.pgPlacement;
...
//             <div className="bg-white rounded-xl p-6" style={{ boxShadow: '0 0 10px 0 rgba(0, 0, 0, 0.2)' }}>
//               <h3 className="text-lg font-semibold text-gray-800 mb-8">
//                 {selectedProgram} Percentage Placement ({parseInt(selectedBatch) - 1}-{selectedBatch.slice(-2)})
//               </h3>
//               <ResponsiveContainer width="100%" height={400}>
//                 <BarChart
//                   data={placementData}
